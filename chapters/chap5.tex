...
\]
$\phi'(\alpha_1) = 80\alpha_1 - 20 = 0$，得 $\alpha_1 = \dfrac{1}{4}$。
...
\]
\[
s_1 = x_2 - x_1 = \left(1,\,-\frac{1}{2}\right)^T, \quad
y_1 = g_2 - g_1 = (3,\,-4)^T
\]
...
\]
\[
\frac{H_1 y_1 y_1^T H_1}{y_1^T H_1 y_1}
= \frac{1}{25}\begin{bmatrix} 9 & -12 \\ -12 & 16 \end{bmatrix}
\]
\[
y_1^T s_1 = 5,\quad
\frac{s_1 s_1^T}{y_1^T s_1}
= \frac{1}{5}\begin{bmatrix} 1 & -1/2 \\ -1/2 & 1/4 \end{bmatrix}
= \begin{bmatrix} 1/5 & -1/10 \\ -1/10 & 1/20 \end{bmatrix}
\]

合并得：
\[
H_2 = \begin{bmatrix}
1-\dfrac{9}{25}+\dfrac{1}{5} & \dfrac{12}{25}-\dfrac{1}{10} \\[8pt]
\dfrac{12}{25}-\dfrac{1}{10} & 1-\dfrac{16}{25}+\dfrac{1}{20}
\end{bmatrix}
= \begin{bmatrix} \dfrac{21}{25} & \dfrac{19}{50} \\[6pt] \dfrac{19}{50} & \dfrac{41}{100} \end{bmatrix}
\approx \begin{bmatrix} 0.84 & 0.38 \\ 0.38 & 0.41 \end{bmatrix}
\]

\textbf{Step 5：新的搜索方向}
\[
d_2 = -H_2 g_2 = -\begin{bmatrix} 21/25 & 19/50 \\ 19/50 & 41/100 \end{bmatrix}
\begin{bmatrix} -1 \\ -2 \end{bmatrix}
= \begin{bmatrix} 8/5 \\ 6/5 \end{bmatrix}
\]
