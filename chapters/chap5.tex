...
\begin{example}[最速下降法]
求解 $\min f(x) = x_1^2 + 4x_2^2$，初始点 $(4, 1)$。
...
通过递推构造共轭方向，不需预先给定。对二次函数：
\begin{align*}
d_0 &= -g_0 \\
d_{k+1} &= -g_{k+1} + \beta_k d_k
\end{align*}
其中 $\beta_k$ 使得 $d_{k+1}^T A d_k = 0$。
\end{conceptbox}
...
$x_1 = (4, 1) + 0.2(-8, -8) = (2.4, -0.6)$

$g_1 = (4.8, -4.8)$，$\beta_0 = \dfrac{46.08}{128} = 0.36$

$d_1 = -g_1 + \beta_0 d_0 = (-4.8, 4.8) + 0.36(-8,-8) = (-7.68, 1.92)$

$\alpha_1 = \dfrac{46.08}{147.456} = 0.3125$

$x_2 = (2.4, -0.6) + 0.3125(-7.68, 1.92) = (0, 0) = x^*$！
\end{example}
...
$f(x) = x_1^2 + 4x_2^2$，$x_0 = (4, 1)$。

$B_0 = I$，$d_0 = (-8, -8)$，$\alpha_0 = 0.2$
