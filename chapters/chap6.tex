...
\begin{example}[KKT条件求解]
求解：
\[
\min \, (x_1 - 2)^2 + (x_2 - 1)^2, \quad \text{s.t. } x_1 + x_2 \leq 2, \; x_1, x_2 \geq 0
\]

改写约束：$g_1 = x_1 + x_2 - 2 \leq 0$，$g_2 = -x_1 \leq 0$，$g_3 = -x_2 \leq 0$
...
2(x_2-1) + \lambda_1 - \lambda_3 &= 0 \\
\lambda_1(x_1 + x_2 - 2) &= 0, \; \lambda_1 \geq 0, \; x_1 + x_2 \leq 2 \\
\lambda_2(-x_1) &= 0, \; \lambda_2 \geq 0, \; x_1 \geq 0 \\
\lambda_3(-x_2) &= 0, \; \lambda_3 \geq 0, \; x_2 \geq 0
\end{align*}

\textbf{Case 1}：假设 $g_1$ 积极，$g_2, g_3$ 不积极 $\Rightarrow \lambda_2 = \lambda_3 = 0$，$x_1 + x_2 = 2$

由前两式：$2(x_1-2) + \lambda_1 = 0$，$2(x_2-1) + \lambda_1 = 0$

相减：$2(x_1 - x_2 - 1) = 0 \Rightarrow x_1 - x_2 = 1$

结合 $x_1 + x_2 = 2$：$x_1 = 1.5$，$x_2 = 0.5$，$\lambda_1 = 1 > 0$ (验证通过)

验证：$x_1, x_2 > 0$（$g_2, g_3$ 不积极），满足所有条件。

最优解：$x^* = (1.5, 0.5)$，最优值 $f^* = 0.5$。
\end{example}
