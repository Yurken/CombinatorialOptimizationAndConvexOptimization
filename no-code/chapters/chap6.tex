...
\begin{example}[二阶必要条件验证]\label{ex:second-order-necessary}
考虑约束优化问题
\[
\min \, f(x_1, x_2) = x_1^2 + x_2^2, \quad \text{s.t. } g(x) = 1 - x_1 \leq 0
\]
...
对任意临界方向 $d = (0, d_2)^T$，有
\[
d^T \nabla_{xx}^2 \mathcal{L} \, d = d^T (2I) d = 2 d_2^2 \geq 0
\]
